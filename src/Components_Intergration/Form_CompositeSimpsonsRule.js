...
export default function Form_CompositeSimpsonsRule() {
    ...
    const calculateCompositeSimpsonsRule = () => {
        if (n % 2 !== 0) {
            alert("n ต้องเป็นเลขคู่เพื่อใช้ Composite Simpson's Rule");
            return;
        }
    ...
    return (
        <div className="container-xxl">
            <div className="border rounded-4 bg-light position-absolute top-50 start-50 translate-middle w-50 p-3 shadow p-3 mb-5 bg-body rounded">
                <center><h1>Composite Simpson's Rule</h1></center>
                <div className="mb-3">
                ...
                <button className="btn btn-danger w-100" onClick={calculateCompositeSimpsonsRule}>
                    Calculate Area
                </button>
                {result !== null && (
